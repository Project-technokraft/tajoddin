        ...
        <nav class="navbar navbar-expand-lg navbar-light"> <a class="navbar-brand" href="#">Navbar</a>
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
              <li class="nav-item active"><a class="nav-link" href="index.html"> Home <span class="caret"><i class="fas fa-caret-down"></i></span></a> <i class="fas fa-caret-down"></i>
                <ul class="submenu">
                  ...
                  <li><a href="index_map.html">Home Map</a></li>
                </ul>
              </li>
              <li class="nav-item"><a class="nav-link" href="#"> Listing <span class="caret"><i class="fas fa-caret-down"></i></span></a> <i class="fas fa-caret-down"></i>
                <ul class="submenu">
                  <li><a href="property_grid.html">Property Grid</a></li>
                  <li><a href="property_list.html">Property List</a></li>
                  <li><a href="property_map.html">Property Map</a></li>
                  <li><a href="property_single.html">Property Single</a></li>
                </ul>
              </li>
              <li class="nav-item"><a class="nav-link" href="#."> Features <span class="caret"><i class="fas fa-caret-down"></i></span></a> <i class="fas fa-caret-down"></i>
                <ul class="submenu">
                  <li><a href="agents.html">Agents</a></li>
                  <li><a href="agents_single.html">Agents Single</a></li>
                  <li><a href="agencies.html">Agencies</a></li>
                  <li><a href="Agencies_single.html">Agencies Details</a></li>
        ...
        <ul class="blog_post">
            ...
            <div class="property_box wow fadeInUp">
              <div class="row">
                <div class="col-lg-6 col-md-6">
                  <div class="propertyImg"><img alt="" src="images/blog01.jpg"></div>
                </div>
                <div class="col-lg-6 col-md-6">
                  <h3><a href="#">The Evolution &amp; Progressive Development of Navi Mumbai Real Estate in the last 10 years</a></h3>
                  <div class="post-meta"> <span>Apr 2, 2021</span></div>
                  <p>Today, Navi Mumbai’s success as a city is admired by its own tremendous growth over time. In a span of almost four decades, it has not only caught up with the existing settlements but has also become the second-largest settlement city</p>
                  <div class="readmore"><a href="blogdetail_1.php">Read More</a></div>
                </div>
              </div>
            </div>
          </li>
          <li>
            <div class="property_box wow fadeInUp">
              <div class="row">
                <div class="col-lg-6 col-md-6">
                  <div class="propertyImg"><img alt="" src="images/blog02.jpg"></div>
                </div>
                <div class="col-lg-6 col-md-6">
                  <h3><a href="#">The Top 5 Important Factors to be considered for Buying your Dream House</a></h3>
                  <div class="post-meta"> <span>Apr 3, 2021</span></div>
                  <p>Are you looking to purchase new house? Buying a Dream home is one of the most important financial decisions you will make in your lifetime.</p>
                  <div class="readmore"><a href="blogdetail_2.php">Read More</a></div>
                </div>
              </div>
            </div>
          </li>
          <li>
            <div class="property_box wow fadeInUp">
              <div class="row">
                <div class="col-lg-6 col-md-6">
                  <div class="propertyImg"><img alt="" src="images/blog03.jpg"></div>
                </div>
                <div class="col-lg-6 col-md-6">
                  <h3><a href="#">A Beginner’s Guide to Taxes and Duties Payable, while Purchasing a New House</a></h3>
                  <div class="post-meta"> <span>Apr 3, 2021</span> </div>
                  <p>Buying a new house is a big financial decision as it will involve your life savings and planning. You not only end up paying for the apartment, but also paying the associated taxes and duties like Stamp</p>
                  <div class="readmore"><a href="blogdetail_3.php">Read More</a></div>
                </div>
              </div>
            </div>
          </li>
          <li>
            <div class="property_box wow fadeInUp">
              <div class="row">
                <div class="col-lg-6 col-md-6">
                  <div class="propertyImg"><img alt="" src="images/blog04.jpg"></div>
                </div>
                <div class="col-lg-6 col-md-6">
                  ...
                  <div class="readmore"><a href="blogdetail_4.php">Read More</a></div>
                </div>
              </div>
            </div>
          </li>
          <li>
            <div class="property_box wow fadeInUp">
              <div class="row">
                <div class="col-lg-6 col-md-6">
                  <div class="propertyImg"><img alt="" src="images/blog05.jpg"></div>
                </div>
                <div class="col-lg-6 col-md-6">
                  <h3><a href="#">Apartment for sale quality</a></h3>
                  <div class="post-meta"> <span>June 21, 2020</span> <span>15 Comments</span> <span>15 Likes</span> </div>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi rhoncus, erat nec sagittis imperdiet, erat libero suscipit. </p>
                  <div class="readmore"><a href="blogdetail_5.php">Read More</a></div>
                </div>
              </div>
            </div>
          </li>
